...
import com.example.syntagi.patient_watch_application.charting.charts.LineChart;
...
import com.example.syntagi.patient_watch_application.charting.utils.NumberUtils;
...
public class LineChartRenderer extends LineRadarRenderer implements Serializable {
    ...
    protected Paint mCirclePaintInnerValue;
    ...
    public LineChartRenderer(LineDataProvider chart, ChartAnimator animator,
                             ViewPortHandler viewPortHandler, LineData lineData) {
        ...
        mCirclePaintInnerValue = new Paint(Paint.ANTI_ALIAS_FLAG);
        mCirclePaintInnerValue.setStyle(Paint.Style.FILL);
        mCirclePaintInnerValue.setColor(Color.BLACK);
        mCirclePaintInnerValue.setTextAlign(Paint.Align.CENTER);

        mCirclePaintInnerValue.setTextSize(30);
    }
    ...
    public void drawHighlighted(Canvas c, Highlight[] indices) {
        ...
        for (Highlight high : indices) {
            ...
            c.drawText(NumberUtils.convertFloatToPrintString(high.getY()), (float) pix.x, (float) pix.y-5, mCirclePaintInnerValue);
