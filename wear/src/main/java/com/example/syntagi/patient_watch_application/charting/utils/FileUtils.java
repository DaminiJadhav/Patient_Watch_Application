    ...
    public static List<Entry> loadEntriesFromFile(String path) {
        ...
        try {
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (split.length <= 2) {
                    entries.add(new Entry(Float.parseFloat(split[0]), NumberUtils.convertToInteger(split[1])));
                } else {
                    ...
                    entries.add(new BarEntry(NumberUtils.convertToInteger(split[split.length - 1]), vals));
