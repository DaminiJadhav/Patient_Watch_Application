...
//            Toast.makeText(AlarmService.this,"Alarm Service Success",Toast.LENGTH_LONG).show();
...
//        }
        ...
        if (alarmNotificationManager!=null){
            Intent intent=new Intent(AlarmService.this,ShowReminderMedicineDetailDB.class);
