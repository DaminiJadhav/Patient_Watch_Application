...
public class Medication_ {
    ...
    @Expose
    private List<Constituent_> constituents = null;
    @SerializedName("dose")
    @Expose
    private String dose;
    ...
    @Expose
    private List<Frequency_> frequencies = null;
    ...
    public List<Constituent_> getConstituents() {
        return constituents;
    }

    public void setConstituents(List<Constituent_> constituents) {
    ...
    public List<Frequency_> getFrequencies() {
        return frequencies;
    }

    public void setFrequencies(List<Frequency_> frequencies) {
