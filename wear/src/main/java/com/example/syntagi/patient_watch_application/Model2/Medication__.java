...
class Medication__ {
    ...
    @Expose
   private List<Constituent__> constituents=null;
    @SerializedName("dose")
    @Expose
    private String dose;
    ...
    @Expose
    private List<Frequency__> frequencies=null;
    ...
    public List<Constituent__> getConstituents() {
        return constituents;
    }

    public void setConstituents(List<Constituent__> constituents) {
    ...
    public List<Frequency__> getFrequencies() {
        return frequencies;
    }

    public void setFrequencies(List<Frequency__> frequencies) {
